...
public class ControlsScreen implements Screen {
	...
	public ControlsScreen(final Project2 game){
		...
		stage = new Stage(new ScreenViewport());//create stage
		...
		String descriptionText = "Try to get the ball into the hole. Watch out for slopes and obstacles! Slopes will decrease the speed of the ball and/or change its direction. When you hit an obstacle you have to start over. (OR #TODO: EDIT)"+"\n";
		Label description = new Label(descriptionText, game.skin);
		...
		String mode1Descr = "Mode 1: Click behind the ball on the opposite side as you want the ball to go. The further you click from the ball, the harder you hit the ball and the further the ball will move."+"\n";
		Label mode1 = new Label(mode1Descr,game.skin);
		...
		String mode2Descr = "Mode 2: All shots (speed and direction) will be loaded from a file."+"\n";
		Label mode2 = new Label(mode2Descr, game.skin);
